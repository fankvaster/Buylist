            ...
            <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
                <div class="container-fluid"><a class="navbar-brand text-dark" href="#">Buylist</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1">
                        ...
                        <span class="btn btn-primary text-dark action-button"><a class="text-dark login green" href="index.php">На главную</a></span>
...
$sql = 'SELECT * FROM list';
        ...
        echo '<a class="green">Ваш список покупок: </a>';
        echo '<form action="clean.php" method="POST"><input class="btn green" type="submit" name="clean" value="Очистить"></form>'.'<br>';
        foreach ($rows as $val) {
            echo '<tr>'."\n";
            echo '<td>'.$val['uid']."\n";
            echo '<td>'.$val['product']."\n";
